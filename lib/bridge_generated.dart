...
abstract class DartJsLibGen extends FlutterRustBridgeBase<DartJsLibGenWire> {
  factory DartJsLibGen(ffi.DynamicLibrary dylib) =>
      DartJsLibGenImpl.raw(DartJsLibGenWire(dylib));
...
class DartJsLibGenImpl extends DartJsLibGen {
  ...
  Future<List<Entry>> parseLibrary({required Config config, dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
          ...
          callFfi: (port) => inner.wire_parse_library(
              port, _api2wire_box_autoadd_config(config)),
...
class DartJsLibGenWire implements FlutterRustBridgeWireBase {
  ...
  DartJsLibGenWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  DartJsLibGenWire.fromLookup(
  ...
  late final _wire_parse_libraryPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Int64, ffi.Pointer<wire_Config>)>>('wire_parse_library');
  late final _wire_parse_library = _wire_parse_libraryPtr
